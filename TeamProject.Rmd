...
The TER is no more than $1 - \text{Accuracy}$. In other words, the percentage of missclassified individuals.
...
In order to try to solve it, we are going to first do stepwise model selection. 
...
It is similar to the BAC computed in the logistic regression.
...
LER
plot(1:15,LER,pch=20,col=color_1,type="b",
