...
kable(cluster_classification(cl_average_X))  %>% kable_styling(latex_options = "HOLD_position")
```
...
kable(cluster_classification(cl_ward_X))  %>% kable_styling(latex_options = "HOLD_position")
```
...
cm_qda_opt$table %>% kable() %>% kable_styling(latex_options = "striped") %>% kable_styling(latex_options = "HOLD_position")
```
...
cm_nb_opt$table %>% kable() %>% kable_styling(latex_options = "striped") %>% kable_styling(latex_options = "HOLD_position")
```
...
colnames(results_table) <- c("KNN", "LR","LR_roc", "LDA","LDA_roc", "QDA","QDA_roc", "NB", "NB_roc")

results_table %>% kable() %>% kable_styling(latex_options = "striped") %>% kable_styling(latex_options = "HOLD_position", full_width = F)
```
